...
export default function MerchantAdminPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#07090e] text-white flex items-center justify-center font-mono text-xs">Loading Admin Portal...</div>}>
      <MerchantAdminContent />
    </Suspense>
  );
}
